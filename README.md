...
(*) PostgREST currently requires a restart for the feature [embedding foreign entities](http://postgrest.com/api/reading/#embedding-foreign-entities) to work as expected after schema changes.
